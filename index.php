...
<body>
    ...
    <div class="col-lg-3">
        ...
        <div class="list-group">
            ...
            <a href="updatepass.php?pass=<?php echo $student_roll?>" class="list-group-item list-group-item-action">Update-Password</a>
        </div>
    </div>
    <div class="col-lg-9">
                <div class="col-lg-6">
                ...
                <div class="col-lg-12 card bg-faded p-0 card-outline-danger">
                ...
                ?>
                        ...
                        <div class="card-footer p-0">
                            <span class="float-xs-right">
                                <a href="payment.php?roll_pay=<?php echo $student_roll;?>" class="pr-1"><small>know more</small></a>
                            </span>
                        </div>
                    </div>
        </div>
